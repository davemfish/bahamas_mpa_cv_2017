...
args = {
        ...
        u'habitats_directory_uri': u'../cv-fromjess/Bahamas_regionalCV_Inputs/Habitats_Final',
        ...
        u'workspace_dir': '../mpa-removeall-habitat/cv-output-invest3.3.0-intacthabitat',
}
